...
class RegistrationForm(forms.Form):
    ...
    date_of_birth = forms.DateField(label='Date of Birth', widget=forms.DateInput(attrs={'placeholder':('Date of Birth')}))
    ...
    def signup(self, request, CustomUser):
        ...
        CustomUser.date_of_birth = self.cleaned_data['date_of_birth']
        CustomUser.save()
